...
return {
  ...
  config = function()
    ...
    -- vim.cmd [[highlight Headline1 guibg=#29b9d4 guifg=#323449]]
    -- vim.cmd [[highlight Headline2 guibg=#c89d63 guifg=#323449]]
    -- vim.cmd [[highlight Headline3 guibg=#8067b3 guifg=#323449]]
    -- vim.cmd [[highlight Headline4 guibg=#1b9783 guifg=#323449]]
    -- vim.cmd [[highlight Headline5 guibg=#91bd65 guifg=#323449]]
    -- vim.cmd [[highlight Headline6 guibg=#7aa2f7 guifg=#323449]]
    --
