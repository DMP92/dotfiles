return {
  ...
  keys = {
    { noremap = true, mode = 'x', '<leader>op', '<cmd>PastifyAfter<CR>', { desc = 'Pastify After' } },
    { noremap = true, mode = 'n', '<leader>op', '<cmd>PastifyAfter<CR>', { desc = 'Pastify After' } },
    { noremap = true, mode = 'n', '<leader>oP', '<cmd>Pastify<CR>', { desc = 'Pastify' } },
  },
  config = function()
